...
\begin{definition}[$\gamma$-Almost Key-Homomorphic PRFs~\cite{boneh2013key}]
...
\sam{add the pseudorandom seed generator stuff. and also add the non-uniform LWE stuff.}

...
As pointed out by \lev{TODO cite}, binary-key learning with errors (resp. binary-key learning with rounding) is secure against PPT adversaries if the underlying LWE (resp. LWR) assumption holds.
...
We use Circom and SnarkJS with Groth16 \lev{TODO cite} to generate the zk-SNARKs.

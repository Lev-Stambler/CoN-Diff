...
Though this may seem like a narrow focus, we note that federated learning, a popular decentralized machine learning technique, is based on the idea of adding gradients from multiple parties \lev{TODO: cite}.
...
\begin{definition}[Correlation Noise Function Generator]
	\lev{TODO}
\end{definition}
